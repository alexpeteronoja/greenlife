...
function Product() {
  return (
    <>
      ...
      <p className="mt-5 text-center text-4xl mb-16">
      ...
      <div className="py-16 mx-8">
        ...
        <div className="flex flex-col md:flex-row gap-7 mt-10">
          ...
          <div className="border-4 border-[#12BA09] rounded-lg p-6">
            ...
            <div className="pt-5">
              "I've been using the Daily Essential Multivitamin for months, and
              I feel a noticeable improvement in my energy levels and overall
              well-being. It's now a staple in my routine."
            </div>
      ...
      <div className="my-12 mx-8 text-center flex justify-center">
        <div className="max-w-[768px]">
          ...
          <p className="my-4.5 text-[#8C8D8B] text-lg">
            ...
            personalized advice and answer all your questions about our products
            and your well-being.
          </p>
